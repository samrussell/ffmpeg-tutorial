...
EXE:=tutorial01.out tutorial02.out tutorial03.out tutorial04.out tutorial05.out tutorial06.out tutorial07.out transcode01.out transcode01-h263.out transcode02.out
